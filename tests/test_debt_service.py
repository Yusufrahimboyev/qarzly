...
async def test_pay_full_debt(
    ...
    assert total_paid == 2000000
    assert summary.total_remaining_debt == 0
...
async def test_pay_partial_debt_fifo(
    ...
    assert summary.total_remaining_debt == 1200000
...
async def test_get_client_report(
    ...
    assert report.total_product_price == 3000000
    assert report.total_exchange_price == 500000
    assert report.total_given_money == 300000
    assert report.total_original_debt == 2200000
    assert report.total_paid_after == 700000
    assert report.total_remaining_debt == 1500000
